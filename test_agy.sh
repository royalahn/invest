#!/bin/bash
set -ex
export GEMINI_API_KEY="" # intentional or maybe not?
agy --dangerously-skip-permissions --print-timeout 15m0s -p "$(cat <<PROMPT
오늘은 2026-06-03이야. 한국과 미국 주식시장의 투자 인사이트 일일 리포트를 작성해줘.
...
## 리포트 작성 규칙 (매우 중요)
- template/base_template.html을 복사하여 daily/daily_2026-06-03_2.html 로 생성
...
## 등록 및 배포
- daily.json에 새 문서 등록 (category: "시장동향", date: "2026-06-03", filename: "daily/daily_2026-06-03_2.html")
- 완료 후:
  git add -A
  git commit -m "docs: 일일 투자 인사이트 (2026-06-03)"
